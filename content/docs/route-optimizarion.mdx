...
<Cards>
  <Card title="Road Trip Planning" description="Plan your road trip by finding the best route to visit multiple destinations." icon="🚗">
  ...
  <Card title="Fleet Management" description="Manage your fleet effectively by optimizing routes for vehicles and drivers." icon="🚚">
  ...
  <Card title="Delivery Route Optimization" description="Find the best routes for delivery trucks and couriers." icon="📦">
  ...
  <Card title="Commute Optimization" description="Find the best route for your daily commute based on your transportation mode." icon="🚌">
...
```bash
curl https://mapapi.gebeta.app/api/route/tss/?json=[]&apiKey={yourapikey}&includeCoordinate=1
```
...
```bash
curl "https://mapapi.gebeta.app/api/route/tss/?json=[8.989022,38.79036;9.03045,38.76530]&apiKey={your-api-key}&includeCoordinate=1"
```
...
<Tabs items={['JavaScript', 'Rust', 'Go', 'PHP', 'Python', 'Ruby', 'Dart']}>
  ...
  ```javascript
fetch('https://mapapi.gebeta.app/api/route/tss/?json=[8.989022,38.79036;9.03045,38.76530]&apiKey={your-api-key}&includeCoordinate=1')
...
fn main() {
    ...
    let url = format!(
        "https://mapapi.gebeta.app/api/route/tss/?json=[{}]&apiKey={}&includeCoordinate=1",
        coordinates, api_key
    );
...
$apiKey = "{your-api-key}";
$coordinates = "8.989022,38.79036;9.03045,38.76530";
$url = "https://mapapi.gebeta.app/api/route/tss/?json=[{$coordinates}]&apiKey={$apiKey}&includeCoordinate=1";
...
coordinates = "8.989022,38.79036;9.03045,38.76530"
url = f"https://mapapi.gebeta.app/api/route/tss/?json=[{coordinates}]&apiKey={api_key}&includeCoordinate=1"
...
api_key = "{your-api-key}"
coordinates = "8.989022,38.79036;9.03045,38.76530"
url = URI("https://mapapi.gebeta.app/api/route/tss/?json=[#{coordinates}]&apiKey=#{api_key}&includeCoordinate=1")
...
void main() async {
  ...
  String url = "https://mapapi.gebeta.app/api/route/tss/?json=[$coordinates]&apiKey=$apiKey&includeCoordinate=1";
