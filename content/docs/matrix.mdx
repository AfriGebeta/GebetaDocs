...
Here’s the information formatted as per your template, including the code examples structured in a tabbed format:
...
| `includeCoordinate`  | `boolean` | Whether to include GPS coordinates or not in the response.                                                   | `no`         |

## Example

Here's the complete implementation for the `curl` request to the Matrix API, including various programming language examples formatted in a tabbed structure:
