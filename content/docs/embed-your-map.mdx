---
title: Embed Map
description: Learn how to generate a shareable, embeddable map iframe from the Gebeta Maps dashboard with markers, bounding box restrictions, and a one-line paste into your site.
---
...
After dropping markers, a list appears below the map where you can add a label to each one. Labels show up as popups when a user clicks the marker in the embed.
...
| Markers | Up to any number, each with an optional label popup |
